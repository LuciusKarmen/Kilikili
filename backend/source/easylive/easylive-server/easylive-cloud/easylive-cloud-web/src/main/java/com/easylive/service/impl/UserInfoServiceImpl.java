...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    @Override
    public void getUserExtendInfo(TokenUserInfoDto tokenUserInfoDto) {
        UserInfo userInfo = getUserInfoByUserId(tokenUserInfoDto.getUserId());
        Integer fansCount = userFocusMapper.selectFansCount(tokenUserInfoDto.getUserId());
        Integer focusCount = userFocusMapper.selectFocusCount(tokenUserInfoDto.getUserId());

        tokenUserInfoDto.setFansCount(fansCount);
        tokenUserInfoDto.setFocusCount(focusCount);
        tokenUserInfoDto.setCurrentCoinCount(userInfo.getCurrentCoinCount());
    }
